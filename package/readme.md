...
## Table of Contents
 ...
 - [Setup](#setup)
	- [Available NPM Scripts](#available_npm_scripts)
...
4. Run `npm install` from project `root` directory (e.g. `../../orion-design-system`)

<div id="available_npm_scripts"></div>
...
#### `npm start`
This script will start stencil in development mode which will watch your files and serve your project on [http://localhost:3333/](http://localhost:3333/)

#### `npm run dev-storybook`
This script will start a Storybook development environment on [http://localhost:6006/](http://localhost:6006/) and will start stencil in watch mode.

#### `npm run generate`
This will run the stencil CLI to generate boilerplate for a new component

#### `npm run build`
This will run the production build for the stencil webcomponent library.

#### `npm run build-storybook`
This will run the production build for Storybook
...
1. PR to `main` branch, approve, merge
1. Merge automated version/CHANGELOG PR
