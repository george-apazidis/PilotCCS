...
const OrionCheckboxGroup$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return orionCheckboxGroupCss; }
}, [1, "orion-checkbox-group", {
    "inline": [4],
    "disabled": [4]
  }]);
function defineCustomElement$1() {
  ...
  const components = ["orion-checkbox-group"];
  components.forEach(tagName => { switch (tagName) {
    case "orion-checkbox-group":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, OrionCheckboxGroup$1);
      }
      break;
  } });
}

const OrionCheckboxGroup = OrionCheckboxGroup$1;
const defineCustomElement = defineCustomElement$1;

export { OrionCheckboxGroup, defineCustomElement };
