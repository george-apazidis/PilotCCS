...
const OrionList$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return orionListCss; }
}, [1, "orion-list"]);
function defineCustomElement$1() {
  if (typeof customElements === "undefined") {
    return;
  }
  const components = ["orion-list"];
  components.forEach(tagName => { switch (tagName) {
    case "orion-list":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, OrionList$1);
      }
      break;
  } });
}

const OrionList = OrionList$1;
const defineCustomElement = defineCustomElement$1;

export { OrionList, defineCustomElement };
