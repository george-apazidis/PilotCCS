...
const OrionPopover$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement$1 {
  constructor() {
    super();
    this.__registerHost();
    this.uid = '';
  ...
  get el() { return this; }
  static get style() { return orionPopoverCss; }
}, [4, "orion-popover", {
    "popperWidth": [1538, "popper-width"],
    "placement": [1537]
  }, [[9, "resize", "handleResize"], [8, "click", "closeWhenFocused"]]]);
function defineCustomElement$1() {
  if (typeof customElements === "undefined") {
    return;
  }
  const components = ["orion-popover"];
  components.forEach(tagName => { switch (tagName) {
    case "orion-popover":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, OrionPopover$1);
      }
      break;
  } });
}

const OrionPopover = OrionPopover$1;
const defineCustomElement = defineCustomElement$1;

export { OrionPopover, defineCustomElement };
