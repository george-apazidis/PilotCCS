...
const OrionDropdownOption$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return orionDropdownOptionCss; }
}, [1, "orion-dropdown-option", {
    "name": [1],
    "disabled": [4],
    "value": [1025],
    "label": [1025],
...
function defineCustomElement$1() {
  ...
  const components = ["orion-dropdown-option"];
  components.forEach(tagName => { switch (tagName) {
    case "orion-dropdown-option":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, OrionDropdownOption$1);
      }
      break;
  } });
}

const OrionDropdownOption = OrionDropdownOption$1;
const defineCustomElement = defineCustomElement$1;

export { OrionDropdownOption, defineCustomElement };
