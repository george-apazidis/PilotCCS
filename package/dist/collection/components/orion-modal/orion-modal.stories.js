...
export default {
  ...
  parameters: {
    ...
    actions: {
      handles: ['keyup', 'orionModalFooterBtnClicked'],
    },
  },
  ...
  // the same category in the ArgsTable
  argTypes: {
    showTitleSlot: getTableSettings('orion-modal-title'),
    showBodySlot: getTableSettings('orion-modal-body'),
    showSecondaryButtonSlot: getTableSettings('orion-modal-secondary-button'),
    showPrimaryButtonSlot: getTableSettings('orion-modal-primary-button'),
    showFooterLeftSlot: getTableSettings('orion-modal-footer-left'),
    showFooterCenterSlot: getTableSettings('orion-modal-footer-center'),
    showFooterRightSlot: getTableSettings('orion-modal-footer-right'),
    slotContentIcon: getTableSettings('icon'),
    ...
    slotContentFooterLeft: getTableSettings('footer left'),
    slotContentFooterCenter: getTableSettings('footer center'),
    slotContentFooterRight: getTableSettings('footer right'),
  },
};
