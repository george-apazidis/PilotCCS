...
export default {
  ...
  // the same category in the ArgsTable
  argTypes: {
    showTitleSlot: getTableSettings('orion-popover-title'),
    showBodySlot: getTableSettings('orion-popover-body'),
    slotContentTitle: getTableSettings('orion-popover-title'),
    slotContentBody: getTableSettings('orion-popover-body'),
  },
};
