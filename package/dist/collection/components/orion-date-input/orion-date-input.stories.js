...
export default {
  ...
  argTypes: {
    ...
    slotContentFirstLabel: getTableSettings('first label'),
    // second label slot content
    slotContentSecondLabel: getTableSettings('second label'),
    // conditional slot content
    slotContentConditional: getTableSettings('conditional'),
    // note slot content,
