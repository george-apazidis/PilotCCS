...
export default {
  ...
  argTypes: {
    showError: {
      description: '**NOT PART OF COMPONENT API**. Toggle the `error` state in this storybook story',
      table: {
        category: 'Story Controls. Not component API',
      },
    },
    slotContentLabel: getTableSettings('label'),
    slotContentError: getTableSettings('error'),
    slotContentNote: getTableSettings('note'),
  },
};
