...
export default {
  ...
  argTypes: {
    slotContentLabel: getTableSettings('button label'),
    buttonWidth: getTableSettings('button width'),
  },
};
...
StickyPrimary.parameters = {
  ...
  docs: {
    description: {
      story: 'Sticky primary button (mobile only). Resize the browser to see the mobile fullscreen modal, or toggle the viewport size in the Canvas view toolbar.',
    },
  },
};
...
StickySecondary.parameters = {
  ...
  docs: {
    description: {
      story: 'Sticky secondary button (mobile only). Resize the browser to see the mobile fullscreen modal, or toggle the viewport size in the Canvas view toolbar.',
    },
  },
};
...
StickyPrimaryDisabled.parameters = {
  ...
  docs: {
    description: {
      story: 'Sticky primary disabled button (mobile only). Resize the browser to see the mobile fullscreen modal, or toggle the viewport size in the Canvas view toolbar.',
    },
  },
};
...
StickySecondaryDisabled.parameters = {
  ...
  docs: {
    description: {
      story: 'Sticky secondary disabled button (mobile only). Resize the browser to see the mobile fullscreen modal, or toggle the viewport size in the Canvas view toolbar.',
    },
  },
};
