...
export default {
  ...
  argTypes: {
    slotContent: getTableSettings('default slot'),
    showImageSlot: getTableSettings('orion-list-item-image'),
    showHeadingSlot: getTableSettings('orion-list-item-heading'),
    showSubheadingSlot: getTableSettings('orion-list-item-subheading'),
    showBodySlot: getTableSettings('orion-list-item-body'),
    slotContentListItemImage: getTableSettings('orion-list-item-image'),
    slotContentListItemHeading: getTableSettings('orion-list-item-heading'),
    slotContentListItemSubheading: getTableSettings('orion-list-item-subheading'),
    slotContentListItemBody: getTableSettings('orion-list-item-body'),
  },
};
